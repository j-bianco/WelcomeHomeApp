     ...
     public class AnimalController : Controller
    {
       private readonly AnimalContext _context;
        ...
        if( _context.Animals.Count() == 0)
        {
          ...
          _context.Animals.Add(new Animal() {Id = 4, User = "rbeardshear", Location ="18835 Winnwood Ln. Santa Ana Ca 92705", Coordinates = "", Name = "Lilly", Type = "Cat", Breed = "Exotic Shorthair", Color = "Brown/Grey", Size = "Med", LostOrFound = "Found", Date = "7/15/17"});
          ...
          _context.Animals.Add(new Animal() {Id = 6, User = "rbeardshear", Location ="18835 Winnwood Ln. Santa Ana Ca 92705", Coordinates = "", Name = "Tina", Type = "Cat", Breed = "Maine Coon", Color = "Black/White", Size = "Sm", LostOrFound = "Found", Date = "9/16/17"});
          ...
          _context.Animals.Add(new Animal() {Id = 9, User = "rbeardshear", Location ="18835 Winnwood Ln. Santa Ana Ca 92705", Coordinates = "", Name = "Ace", Type = "Dog", Breed = "Poodle", Color = "Black/Grey", Size = "Lrg", LostOrFound = "Found", Date = "7/1/17"});
          ...
          _context.Animals.Add(new Animal() {Id = 11, User = "rbeardshear", Location ="18835 Winnwood Ln. Santa Ana Ca 92705", Coordinates = "", Name = "Milo", Type = "Dog", Breed = "Rottweiler", Color = "Tan/White", Size = "Lrg", LostOrFound = "Foud", Date = "5/12/16"});
