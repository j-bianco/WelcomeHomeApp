     ...
     public class AnimalController : Controller
    {
       private readonly AnimalContext _context;
        ...
        if( _context.Animals.Count() == 0)
        {
          ...
          _context.Animals.Add(new Animal() {Id = 2, User = "rbeardshear", Location ="1524 Maurine Place Fullerton CA 92831", Coordinates =Animal.GetCoordinates("1524 Maurine Place Fullerton CA 92831"), Name = "Chloe", Type = "Cat", Breed = "Persian", Color = "Grey/White", Size = "Sm", LostOrFound = "Found", Date = "3/2/17"});
          _context.Animals.Add(new Animal() {Id = 3, User = "rbeardshear", Location ="1033 N Custer Street Santa Ana CA 92701", Coordinates =Animal.GetCoordinates("1033 N Custer Street Santa Ana CA 92701"), Name = "Ryder", Type = "Dog", Breed = "German Shepherd", Color = "Brown/Black", Size = "Lrg", LostOrFound = "Found", Date = "1/21/17"});
          ...
          _context.Animals.Add(new Animal() {Id = 6, User = "rbeardshear", Location ="1800 W Santa Clara Ave Santa Ana CA 92706", Coordinates =Animal.GetCoordinates("1800 W Santa Clara Ave Santa Ana CA 92706"), Name = "Tina", Type = "Cat", Breed = "Maine Coon", Color = "Black/White", Size = "Sm", LostOrFound = "Found", Date = "9/16/17"});
          ...
          _context.Animals.Add(new Animal() {Id = 8, User = "rbeardshear", Location ="1313 Disneyland Dr Anaheim CA 92802", Coordinates =Animal.GetCoordinates("1313 Disneyland Dr Anaheim CA 92802"), Name = "Mickey", Type = "Dog", Breed = "Beagle", Color = "Brown/White", Size = "Med", LostOrFound = "Found", Date = "10/1/16"});
          ...
          _context.Animals.Add(new Animal() {Id = 10, User = "rbeardshear", Location ="321 E Chapman Ave Fullerton CA 92832", Coordinates =Animal.GetCoordinates("321 E Chapman Ave Fullerton CA 92832"), Name = "Rocky", Type = "Cat", Breed = "British Shorthair", Color = "Tan", Size = "Sm", LostOrFound = "Found", Date = "1/1/16"});
          _context.Animals.Add(new Animal() {Id = 11, User = "rbeardshear", Location ="800 N. State College Fullerton CA 92831", Coordinates =Animal.GetCoordinates("800 N. State College Fullerton CA 92831"), Name = "Milo", Type = "Dog", Breed = "Rottweiler", Color = "Tan/White", Size = "Lrg", LostOrFound = "Found", Date = "5/12/16"});
          _context.Animals.Add(new Animal() {Id = 12, User = "rbeardshear", Location ="18001 Yorba Linda Blvd Yorba Linda CA 92886", Coordinates =Animal.GetCoordinates("18001 Yorba Linda Blvd Yorba Linda CA 92886"), Name = "Pretty Boy", Type = "Turtle", Breed = "Box Turtle", Color = "Green", Size = "Sm", LostOrFound = "Found", Date = "5/16/17"});
